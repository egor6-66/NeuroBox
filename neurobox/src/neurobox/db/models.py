...
class NoteKind(StrEnum):
    ...
    Хорошее записывается наравне с плохим и намеренно: по одним затыкам не видно, что работает,
    и разбор превращается в список жалоб. Похвала говорит, что трогать НЕ надо.
    """
